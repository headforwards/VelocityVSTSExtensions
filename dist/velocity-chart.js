define(["require", "exports"], function (require, exports) {
    ...
    var VelocityChart = (function () {
        function VelocityChart(velocity, divId, chartTitle) {
            ...
            this.data.addColumn({ type: "number", role: "interval", label: "Rolling Average Velocity LOW" });
            this.data.addColumn({ type: "number", role: "interval", label: "Rolling Average Velocity HIGH" });
            var counter = 0;
